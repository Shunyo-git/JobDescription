...
Namespace BusinessLogicLayer
    ...
    Public Class PMUser
        ...
        Public Shared Function GetUsers(ByVal userID As Integer, ByVal role As String) As UsersCollection
            ...
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_ListUsers", userID, Convert.ToInt32(role))
        ...
        Public Shared Function IsProjectMember(ByVal projectID As Integer, ByVal UserID As Integer) As Boolean
            ...
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetMemberByUserID", UserID, projectID)
            ' Separate Data into a collection of Users.
            Dim r As DataRow
            For Each r In ds.Tables(0).Rows
        ...
        Public Shared Function GetMembers(ByVal projectID As Integer) As UsersCollection
            ...
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_ListMembers", projectID)
            Dim users As New UsersCollection
        ...
        Public Shared Function ListManagers() As UsersCollection
            ...
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), CommandType.StoredProcedure, "PM_ListManagers")
        ...
        Public Shared Sub RemoveMember(ByVal MemberID As Integer)
            SqlHelper.ExecuteNonQuery(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_DeleteMember", MemberID)
        End Sub 'RemoveMember

        Public Shared Sub RemoveUser(ByVal ID As Integer)
            SqlHelper.ExecuteNonQuery(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_DeleteUser", ID)
        End Sub 'RemoveUser
        ...
        Public Function LoadProjectMember() As Boolean
            ...
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetProjectUser", _userID, _projectID)
        ...
        Public Function Load() As Boolean
            ...
            If _memberID <= 0 Then
                ...
                _role = Convert.ToInt32(SqlHelper.ExecuteScalar(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetUserRole", _userID))
                _roleName = Roles.GetRolesName(_role)

            Else

                Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetProjectMember", _memberID)
        ...
        Private Function Insert(ByVal checkUsername As Boolean, ByRef isUserFound As Boolean) As Boolean
            ...
            If checkUsername And isUserFound Or Not checkUsername Then
                ...
                _memberID = Convert.ToInt32(SqlHelper.ExecuteScalar(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_AddUser", _userID, Convert.ToInt32(_role), _groupID, _projectID, _description, _Connects, _sourceUserTitle, _sourceUserDepartment, _CurrentUserID))
                isUserFound = True
            End If
            Return _memberID > 0
        End Function 'Insert
        ...
        Private Function Update(ByRef isUserActiveManger As Boolean) As Boolean
            ...
            If _role = Roles.UserRoleUser Then
                If Convert.ToInt32(SqlHelper.ExecuteScalar(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetManagerProjectCount", _userID)) > 0 Then
                ...
                End If
            End If
            Return 0 < Convert.ToInt32(SqlHelper.ExecuteScalar(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_UpdateUser", _memberID, _userID, Convert.ToInt32(_role), _groupID, _projectID, _description, _Connects, _sourceUserTitle, _sourceUserDepartment, _CurrentUserID))
        End Function 'Update

        Public Shared Function GetUserGroupID(ByVal MemberID As Integer, ByVal ProjectID As Integer) As Integer
            Return Convert.ToInt32(SqlHelper.ExecuteScalar(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetUserGroup", MemberID, ProjectID))
        End Function
        ...
        Public Shared Function GetUserDeptTitle(ByVal userID As Integer) As DataSet

            Return (SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetUserDeptTitle", userID))
        End Function
    End Class 'PMUser
