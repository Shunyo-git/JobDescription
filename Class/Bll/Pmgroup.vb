...
#End Region
        ...
        Public Shared Function GetGroupName(ByVal GroupID As Integer) As String
            Return Convert.ToString(SqlHelper.ExecuteScalar(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetGroupName", GroupID))
        End Function
        ...
        Public Function Load() As Boolean
            ...
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetGroup", _groupID)
        ...
        Public Shared Function GetGroups() As GroupsCollection
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_ListAllGroups")
        ...
        Public Shared Function GetProjectGroups(ByVal projectID As Integer) As GroupsCollection
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_ListGroups", projectID)
            Dim GroupArray As New GroupsCollection
        ...
        Public Shared Sub RemoveGroup(ByVal ID As Integer)
            SqlHelper.ExecuteNonQuery(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_DeleteGroup", ID)
        End Sub 'RemoveGroup
        '*********************************************************************
        '
        ...
        Private Function Insert() As Boolean
            ...
            Try
                _groupID = Convert.ToInt32(SqlHelper.ExecuteScalar(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_AddGroup", _projectID, _name, _description, getSelectedMembers.ToString(), _modifiedUserID))
        ...
        Private Function Update() As Boolean
            ...
            Try
                SqlHelper.ExecuteNonQuery(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_UpdateGroup", _groupID, _projectID, _name, _description, getSelectedMembers.ToString, _modifiedUserID)
                blnResult = True
            Catch ex As Exception
                Throw ex
                blnResult = False
