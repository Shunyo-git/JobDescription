...
Namespace BusinessLogicLayer
    ...
    Public Class Roles
        ...
        Public Shared Function GetRolesName(ByVal RoleID As Integer) As String
            Return Convert.ToString(SqlHelper.ExecuteScalar(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_GetRolesName", RoleID))
        End Function

        Public Shared Function GetRoles() As RolesCollection
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_ListAllRoles")
        ...
        Public Shared Function GetProjectRoles() As RolesCollection
            Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationSettings.AppSettings(Web.Global.CfgKeyHsinYiJDConnString), "PM_ListProjectRoles")
            Dim roleArray As New RolesCollection
